    ...
    <header className="border-b border-stone-200/60 sticky top-0 bg-[#f7f3ea]/95 backdrop-blur-sm z-10">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 h-14 flex items-center justify-between gap-2">
        <button
          ...
          className="flex items-center gap-2 hover:opacity-80 transition-opacity cursor-pointer bg-transparent border-0 p-0 shrink-0"
          aria-label="Go to top"
        >
          <span className="font-serif italic text-xl text-[#1f5c3a] font-bold">Neduresume</span>
          <span className="hidden md:inline-flex items-center gap-1 text-[10px] font-semibold text-[#1f5c3a]/70 tracking-wide">
            powered by AI
          </span>
        </button>
