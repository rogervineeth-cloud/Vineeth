      ...
      <header className="border-b border-stone-200/60 sticky top-0 bg-[#f7f3ea]/95 backdrop-blur-sm z-10">
        <div className="max-w-6xl mx-auto px-6 h-14 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="hidden sm:inline-flex items-center gap-1 text-[10px] font-semibold bg-[#1f5c3a] text-white px-2 py-0.5 rounded-full tracking-wide">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <div className="inline-flex items-center gap-2 bg-[#1f5c3a]/10 border border-[#1f5c3a]/25 text-[#1f5c3a] text-xs font-semibold px-3 py-1.5 rounded-full mb-6">
              ...
              Powered by AI · Neduresume AI
            </div>
            <h1 className="font-serif italic text-4xl sm:text-5xl lg:text-[3.25rem] text-[#1a1a1a] leading-[1.15] mb-5">
              Your AI resume,<br />tailored to the job —<br />
              <span className="text-[#1f5c3a]">in 60 seconds.</span>
            </h1>
            <p className="text-[#6b6b6b] text-base sm:text-lg max-w-lg mb-8 leading-relaxed">
              Paste a job description. Our AI reads it, matches your profile, and writes a resume that gets shortlisted — ATS-ready, every time.
            </p>
            {/* Two-path CTAs */}
            ...
            <div className="flex flex-wrap gap-2 mb-4">
              ...
              <span className="text-xs rounded-full border border-[#3d6b4f]/30 text-[#3d6b4f] px-3 py-1">✦ LinkedIn-ready</span>
              <span className="text-xs rounded-full border border-[#3d6b4f]/30 text-[#3d6b4f] px-3 py-1">✦ Naukri-ready</span>
              <span className="text-xs rounded-full border border-[#3d6b4f]/30 text-[#3d6b4f] px-3 py-1">✦ Built for India</span>
            </div>
