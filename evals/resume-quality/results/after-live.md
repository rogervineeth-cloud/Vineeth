# Resume-quality eval — results/after-live

- Mode: **live model (captured from preview: live-after)**  |  Model: `claude-haiku-4-5-20251001`  |  JD sources: OFFICIAL_PARAPHRASE
...
| S10 | 48 | 0.034 | 1 | 1 | PASS | FAIL | PASS | FAIL | PASS | PASS | PASS | PASS | weak |
...
- **S10** [factual_fidelity] unverifiable number "5 (in Brightline Retail Tech bullet)"
