# Resume-quality eval — results/final-live-reprocessed

- Mode: **live model (captured from preview: live-final, re-post-processed with current code)**  |  Model: `claude-haiku-4-5-20251001`  |  JD sources: OFFICIAL_PARAPHRASE
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| S01 | 38 | 0 | 1 | 1 | PASS | PASS | PASS | PASS | FAIL | PASS | PASS | PASS | PASS | PASS | PASS | adequate |
| S02 | 48 | 0 | 1 | 1 | PASS | PASS | PASS | PASS | PASS | PASS | PASS | PASS | PASS | PASS | PASS | strong |
| S03 | 38 | 0 | 1 | 1 | PASS | PASS | PASS | PASS | PASS | PASS | PASS | PASS | PASS | PASS | PASS | strong |
...
| S06 | 68 | 0 | 1 | 1 | PASS | PASS | PASS | PASS | PASS | PASS | PASS | PASS | PASS | PASS | PASS | strong |
