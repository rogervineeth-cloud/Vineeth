# Offline guard audit — offline-corpus-after
...
| tailored | 17 | 17 | 0 | 0 | 0 | 0 | 17 | 5/5 |
| verb_swap | 2 | 0 | 1 | 1 | 0 | 0 | 1 | 2/2 |
| truthful_unscoped | 4 | 0 | 0 | 4 | 0 | 0 | 0 | 4/4 |
| one_unsupported | 22 | 0 | 16 | 6 | 0 | 0 | 16 | 17/17 |
| fabricated | 15 | 0 | 0 | 8 | 7 | 0 | 0 | 7/8 |

## Case level

- Gates passing (of 12): factual_fidelity 12, ats_keywords 12, seniority_calibration 11, section_completeness 12, readability 12, career_gap 12, projects_vs_employment 12, detail_fidelity 12, summary_framing 12, advice_fidelity 12
- Summary names the target role: 12/12; summary fell back to the candidate's own: 0/12
- Every source bullet's numbers preserved in the full resume: 12/12
- Items that should keep content but lost all tailoring: 11

## Items

| Case | Where | Kind | Outcome | Clean | Final |
|---|---|---|---|---|---|
| N01 | summary | tailored | kept | yes | Digital Marketing Executive with 3+ years of professional experience running Google Ads and Meta Ads campaigns for D2C brands, seeking the Performance Marketing Manager role. |
| N01 | summary | one_unsupported | trimmed | yes | Cut cost per acquisition from Rs 640 to Rs 410 through creative testing. |
...
| N01 | bullet | one_unsupported | trimmed | yes | Reduced cost per acquisition from Rs 640 to Rs 410 by testing 25 creatives and restructuring ad sets. |
...
| N02 | bullet | one_unsupported | trimmed | yes | Reconciled 14 bank accounts and vendor ledgers monthly in SAP FICO. |
...
| N03 | summary | one_unsupported | trimmed | yes | Closed 85 hires in 2024 through sourcing on LinkedIn Recruiter and Naukri. |
| N03 | bullet | tailored | kept | yes | Closed 85 tech and operations hires in 2024 with an average time-to-hire of 28 days. |
| N03 | bullet | one_unsupported | trimmed | yes | Sourced candidates on LinkedIn Recruiter and Naukri, screening 60 profiles a week. |
...
| N04 | summary | one_unsupported | trimmed | yes | Achieved 118% of the annual quota in 2025. |
...
| N04 | bullet | one_unsupported | trimmed | yes | Negotiated renewal discounts with 30 SMB SaaS customers. |
...
| N06 | bullet | one_unsupported | trimmed | yes | Automated a weekly margin report with SQL queries, saving 5 hours a week. |
| N06 | bullet | verb_swap | trimmed | yes | Cleaned 3 years of POS data in Pandas and Python for a pricing study. |
| N06 | project | one_unsupported | trimmed | yes | Pandas and Python analysis of 10,000 telecom customers identifying 4 churn drivers. |
...
| N07 | bullet | one_unsupported | trimmed | yes | Designed 30 lesson plans and Google Classroom quizzes aligned to the CBSE syllabus. |
...
| N08 | summary | one_unsupported | trimmed | yes | Raised CSAT from 82% to 91%. |
| N08 | bullet | faithful | kept | yes | Led a team of 9 support agents handling 2,400 tickets a month in Zendesk. |
| N08 | bullet | one_unsupported | trimmed | yes | Raised CSAT from 82% to 91% by rewriting 35 macros and help-centre articles. |
...
| N09 | bullet | one_unsupported | trimmed | yes | Recorded medication and vitals in the electronic health record every shift. |
| N09 | bullet | fabricated | reverted | yes | Cared for 6 to 8 cardiac patients per shift in a 30-bed ward. |
...
| N10 | bullet | one_unsupported | trimmed | yes | Prepared 3 bank reconciliation statements monthly for the proprietor. |
| N10 | project | one_unsupported | trimmed | yes | Excel workbook that flags mismatches and tracks GST on 150 sample invoices. |
| N11 | summary | tailored | kept | yes | Graphic Designer with 3+ years of professional experience in social media, packaging and brand identity design, seeking the UI/UX Designer role. |
...
| N12 | summary | one_unsupported | trimmed | yes | Reduced customer complaints from 14 to 4 a quarter using 8D root cause analysis. |
